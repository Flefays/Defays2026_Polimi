...
Note:
    Distinct marker shapes are used for each fluid to ensure readability 
    in grayscale or for colorblind users.
...
for fig, name in [(fig1, "Pevap_vs_Tgeo"), (fig2, "NetPower_vs_Tgeo"),
                   (fig3, "Treinj_vs_Tgeo")]:
